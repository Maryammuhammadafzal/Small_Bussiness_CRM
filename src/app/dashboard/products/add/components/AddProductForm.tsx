...
const AddProductForm = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        else if (formData.product_description.trim().split(/\s+/).length < 50) return toast.error("Product description must be atleast 50 words");
        // else if (formData.product_description.trim().split(/\s+/).length > 300) return toast.error("Product description should not exeed to 300 words");
